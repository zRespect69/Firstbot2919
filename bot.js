...
client.on('ready', async() => {
    console.log('hello')
    const server = "590894166410788865"; // ايدي السررفر
const channel = "590894166410788867";//ايدي الروم
    setInterval(()=>{
    client.guilds.get(server).channels.get(channel).send(`**تفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجيرتفجير
